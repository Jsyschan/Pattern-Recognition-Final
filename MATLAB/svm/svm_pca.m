...
red3Classifier = fitcsvm(reduced_red_data_train, red_class_3_train, 'KernelScale', 'auto', 'KernelFunction', 'polynomial', 'Standardize', true);
disp('3 Done');
red4Classifier = fitcsvm(reduced_red_data_train, red_class_4_train, 'KernelScale', 'auto', 'KernelFunction', 'polynomial', 'Standardize', true);
disp('4 Done');
red5Classifier = fitcsvm(reduced_red_data_train, red_class_5_train, 'KernelScale', 'auto', 'KernelFunction', 'polynomial', 'Standardize', true);
disp('5 Done');
red6Classifier = fitcsvm(reduced_red_data_train, red_class_6_train, 'KernelScale', 'auto', 'KernelFunction', 'polynomial', 'Standardize', true);
disp('6 Done');
red7Classifier = fitcsvm(reduced_red_data_train, red_class_7_train, 'KernelScale', 'auto', 'KernelFunction', 'polynomial', 'Standardize', true);
disp('7 Done');
red8Classifier = fitcsvm(reduced_red_data_train, red_class_8_train, 'KernelScale', 'auto', 'KernelFunction', 'polynomial', 'Standardize', true);
disp('8 Done');

disp('Predicting labels');
[label3, score3] = predict(red3Classifier, reduced_red_data_test);
disp('3 Done');
[label4, score4] = predict(red4Classifier, reduced_red_data_test);
disp('4 Done');
[label5, score5] = predict(red5Classifier, reduced_red_data_test);
disp('5 Done');
[label6, score6] = predict(red6Classifier, reduced_red_data_test);
disp('6 Done');
[label7, score7] = predict(red7Classifier, reduced_red_data_test);
disp('7 Done');
[label8, score8] = predict(red8Classifier, reduced_red_data_test);
disp('8 Done');
